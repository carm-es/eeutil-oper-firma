...
public class XAdESPostProcessor implements PostProcessor{
	...
	@Override
	public byte[] postProcessSign(byte[] sign) throws IOException, PostProcessException, XPathFactoryConfigurationException {
		...
		try {
			...
			throw new PostProcessException ("Error al convertir la nueva firma a un array de bytes:" + e.getMessage(), e);
		}
	...
	private boolean esContenidoDocumentoB64 (Node nodo) {
		...
		// Este nodo contendrá el documento en b64 cuando el atributo encoding lo marque y cuando el mymetipe no sea "hash/algo".		
	...
	private NodeList obtenerUnsignedSignaturePropertiesVacios (javax.xml.xpath.XPath xpath, Element element) {
