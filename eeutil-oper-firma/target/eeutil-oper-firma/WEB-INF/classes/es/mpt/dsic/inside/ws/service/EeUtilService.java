...
public interface EeUtilService {
	...
	public ListaFirmaInfo  obtenerFirmantes(@WebParam(name = "aplicacionInfo")  @XmlElement(required=true,name="aplicacionInfo")ApplicationLogin info,	
	...
	public ResultadoValidacionInfo  validacionFirma(@WebParam(name = "aplicacionInfo")  @XmlElement(required=true,name="aplicacionInfo")ApplicationLogin info,	
			@WebParam(name = "Firma")  @XmlElement(required=true,name="Firma")byte[] firma,			
			@WebParam(name = "TipoFirma")  @XmlElement(required=false,name="TipoFirma")String tipoFirma,
			@WebParam(name = "DatosFirmados")  @XmlElement(required=false,name="DatosFirmados")DatosFirmados datosFirmados)  throws InSideException;
	...
	public InformacionFirma  obtenerInformacionFirma(@WebParam(name = "aplicacionInfo")  @XmlElement(required=true,name="aplicacionInfo") ApplicationLogin info,	
			@WebParam(name = "Firma")  @XmlElement(required=true,name="Firma") byte[] firma,
	...
	public ResultadoAmpliarFirma  ampliarFirma(@WebParam(name = "aplicacionInfo")  @XmlElement(required=true,name="aplicacionInfo") ApplicationLogin info,	
			@WebParam(name = "Firma")  @XmlElement(required=true,name="Firma") byte[] firma,
	...
	public byte[]  postProcesarFirma(@WebParam(name = "aplicacionInfo")  @XmlElement(required=true,name="aplicacionInfo")ApplicationLogin info,	
			@WebParam(name = "Firma")  @XmlElement(required=true,name="Firma")byte[] firma)  throws InSideException;
	...
	public ResultadoAmpliarFirma  resellarFirmaA(@WebParam(name = "aplicacionInfo")  @XmlElement(required=true,name="aplicacionInfo") ApplicationLogin info,	
			@WebParam(name = "Firma")  @XmlElement(required=true,name="Firma") byte[] firma
			)  throws InSideException;
