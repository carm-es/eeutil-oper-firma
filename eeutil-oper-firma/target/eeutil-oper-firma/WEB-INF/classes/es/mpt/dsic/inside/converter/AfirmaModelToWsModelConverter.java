...
public class AfirmaModelToWsModelConverter {
	...
	public static ResultadoValidacionInfo resultadoValidacionInfoAfirmaToResultadoValidacionInfo (ResultadoValidacionInfoAfirma resAfirma) {
		if (resAfirma == null) {
			return null;
		}
	...
	public static InformacionFirma informacionFirmaAfirmaToInformacionFirma (InformacionFirmaAfirma infoAfirma) {
	...
	public static ListaFirmaInfo listaFirmaInfoAfirmaToListaFirmaInfo (List<FirmaInfoAfirma> listaAfirma) {
		if (listaAfirma == null) {
			return null;
		}
	...
	public static ResultadoValidarCertificado resultadoValidarCertificadoAfirmaToResultadoValidarCertificado (ResultadoValidarCertificadoAfirma resAfirma) {
		if (resAfirma ==  null) {
			return null;
		}
	...
	public static InfoCertificado resultadoValidarCertificadoAfirmaToResultadoValidarCertificadoAmpliado (ResultadoValidarCertificadoAfirma resAfirma) {
		if (resAfirma ==  null) {
			return null;
		}
		...
		if (resAfirma.getInfoCertificado() != null) {
			...
			for (Entry entry : resAfirma.getInfoCertificado().entrySet()) {
				detalle.add(new InfoDetalladaCertificado((String) entry.getKey(), (String) entry.getValue()));
			}
	...
	public static ResultadoAmpliarFirma resultadoAmpliarFirmaAfirmaToResultadoAmpliarFirma (ResultadoAmpliarFirmaAfirma resAfirma) {
		if (resAfirma ==  null) {
			return null;
		}
	...
	public static ConfiguracionAmpliarFirmaAfirma configuracionAmpliarFirmaToConfiguracionAmpliarFirmaAfirma (ConfiguracionAmpliarFirma conf) {
		if (conf == null) {
			return null;
		}
