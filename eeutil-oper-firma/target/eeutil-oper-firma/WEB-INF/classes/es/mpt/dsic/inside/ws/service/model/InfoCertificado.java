...
@XmlType(name="infoCertificado", propOrder={"validado", "idUsuario", "numeroSerie", "detalleValidacion", "informacionDetallada"})
public class InfoCertificado {
	...
	public void setInformacionDetallada(
			List<InfoDetalladaCertificado> informacionDetallada) {
