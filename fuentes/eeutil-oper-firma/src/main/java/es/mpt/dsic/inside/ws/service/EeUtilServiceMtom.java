...
public interface EeUtilServiceMtom {
  ...
  public ListaFirmaInfo obtenerFirmantes(
      ...
      @WebParam(name = "FirmaMtom") @XmlElement(required = true, name = "FirmaMtom")
      @XmlMimeType("application/octet-stream") DataHandler firma,
      // @WebParam(name = "FirmaMtom") @XmlElement(required = true, name = "FirmaMtom")
      // @XmlMimeType("application/octet-stream") DataHandler datos,
  ...
  public ResultadoValidacionInfo validacionFirma(
      @WebParam(name = "aplicacionInfo")
      @XmlElement(required = true, name = "aplicacionInfo") ApplicationLogin info,
      @WebParam(name = "FirmaMtom") @XmlElement(required = true, name = "Firma")
      @XmlMimeType("application/octet-stream") DataHandler firma,
      @WebParam(name = "TipoFirma")
      @XmlElement(required = false, name = "TipoFirma") String tipoFirma,
      @WebParam(name = "DatosFirmadosMtom")
      @XmlElement(required = false, name = "DatosFirmadosMtom") DatosFirmadosMtom datosFirmadosMtom)
      throws InSideException;

  @WebMethod(operationName = "validacionFirmaInfo", action = "urn:validacionFirmaInfo")
  @WebResult(name = "ResultadoValidacionFirmaInfo", partName = "ResultadoValidacionFirmaInfo")
  public ResultadoValidacionFirmaInfo validacionFirmaInfo(
      @WebParam(name = "aplicacionInfo")
      @XmlElement(required = true, name = "aplicacionInfo") ApplicationLogin info,
      @WebParam(name = "FirmaMtom") @XmlElement(required = true, name = "Firma")
      @XmlMimeType("application/octet-stream") DataHandler firma,
      ...
      @WebParam(name = "DatosFirmadosMtom")
      @XmlElement(required = false, name = "DatosFirmadosMtom") DatosFirmadosMtom datosFirmadosMtom,
      @WebParam(name = "InfoCertificadosMtom")
      @XmlElement(required = false, name = "InfoCertificadosMtom") boolean infoCertificadosMtom)
      throws InSideException;
  ...
  public InformacionFirma obtenerInformacionFirma(
      ...
      @WebParam(name = "ContenidoMtom") @XmlElement(required = false, name = "ContenidoMtom")
      @XmlMimeType("application/octet-stream") DataHandler contenido) throws InSideException;
  ...
  public DataHandler postProcesarFirma(
      ...
      @XmlElement(required = true, name = "aplicacionInfo") ApplicationLogin info,
      @WebParam(name = "FirmaMtom") @XmlElement(required = true, name = "FirmaMtom")
      @XmlMimeType("application/octet-stream") DataHandler firma) throws InSideException;
  ...
  public ResultadoValidarCertificado validarCertificado(
      @WebParam(name = "aplicacionInfo")
      @XmlElement(required = true, name = "aplicacionInfo") ApplicationLogin info,
      @WebParam(name = "certificate")
      @XmlElement(required = true, name = "certificate") String certificate) throws InSideException;
  ...
  public ResultadoAmpliarFirmaMtom resellarFirmaA(
      @WebParam(name = "aplicacionInfo")
      @XmlElement(required = true, name = "aplicacionInfo") ApplicationLogin info,
      @WebParam(name = "FirmaMtom") @XmlElement(required = true, name = "FirmaMtom")
      @XmlMimeType("application/octet-stream") DataHandler firma) throws InSideException;
