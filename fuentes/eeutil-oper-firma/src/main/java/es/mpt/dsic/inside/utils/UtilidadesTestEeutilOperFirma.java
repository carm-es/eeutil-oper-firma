 ...
 *
 */
public class UtilidadesTestEeutilOperFirma implements IPruebaTraza {
  protected static final Log logger = LogFactory.getLog(UtilidadesTestEeutilOperFirma.class);
  ...
  public String testTrazaImp() {
    ...
    logger.error("Is implementation SLF4JLocationAwareLog " + bImpSLF4JLocationAwareLog
        ...
        + " Verificacion de que la traza en eeutil-oper-firma es correcta");
