...
@XmlType(name = "configuracionAmpliarFirma",
    propOrder = {"formatoAmpliacion", "ignorarPeriodoDeGracia", "certificadosFirmantes"})
public class ConfiguracionAmpliarFirma extends DataWsEntradaBase implements IMDCAble {
